...
def predictionMethod_1(currentUser, targetMovie, communityResult):
	...
	# print "user not in community", currentUser
	return 0
	...
	for communityMember in communityResult:
		if (communityMember.IsNIdIn(targetMovie + 1)):  # current user is in this community
			...
			if (totalCnt == 0):
				...
				return cumulatedScore * 1.0 / simuSum
	# print "movie not in community", targetMovie
	return 0
...
def main():
	...
	print "test result One is : "
	# systemTest(1, 500, 1, 10, UGcommunityResult, 1)
	# systemTest(1, 500, 1, 10, UGcommunityResult, 3)
	systemTest(1, 500, 1, 100, MGcommunityResult, 2)
	# systemTest(1, 500, 1, 10, MGcommunityResult, 4)
